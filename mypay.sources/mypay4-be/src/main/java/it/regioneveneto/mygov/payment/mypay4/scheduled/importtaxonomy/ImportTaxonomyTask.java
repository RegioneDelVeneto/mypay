...
public class ImportTaxonomyTask {

	@Autowired
	ImportTaxonomyTaskService importTaxonomyTaskService;

	@Scheduled(cron = "${task.importTaxonomy.cronExpression}")
	public void importTaxonomyTaskScheduler() { importTaxonomyTaskService.importTaxonomy(); }
}
