...
@Schema(description = "informazioni del dovuto da pagare")
public class DovutoTo extends BaseTo implements Serializable {
  ...
  @Schema(description = "Data entro qui effettuare il pagamento", example = "2023/08/23")
  private LocalDate dataScadenza;
  @Schema(description = "importo di centesimi di Euro", example = "100")
  private Long importo;
  @Schema(description = "indirizzo utile al download dell'avviso di pagamento in formato PDF")
  private String urlDownloadAvviso;
  @Schema(description = "identificativo univoco per l'innesco del pagamento")
