...
public class ChiediFlussoRendicontazioneTaskApplication extends AbstractTaskApplication {
  final static public String NAME = "ChiediFlussoRendicontazioneTaskApplication";
