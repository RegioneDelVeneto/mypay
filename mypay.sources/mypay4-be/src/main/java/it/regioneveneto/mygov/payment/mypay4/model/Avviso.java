...
public class Avviso extends BaseEntity {
  ...
  public static final String ALIAS = "Avviso";
  public static final String FIELDS = ""+ALIAS+".mygov_avviso_id as Avviso_mygovAvvisoId,"+ALIAS+".version as Avviso_version"+
