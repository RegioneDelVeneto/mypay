...
@Component
@NoArgsConstructor
public class DovutoElaboratoEntePrimarioToMapper implements RowMapper<DovutoElaboratoEntePrimarioTo> {


    @Override
    public DovutoElaboratoEntePrimarioTo map(ResultSet rs, StatementContext ctx) throws SQLException {
        DovutoElaboratoEntePrimarioTo.DovutoElaboratoEntePrimarioToBuilder builder = DovutoElaboratoEntePrimarioTo.builder()
                .denominazioneBeneficiario(rs.getString("de_nome_ente"))
