...
public class GiornaleService {
  ...
  public List<String> getAllPspPa(){
    return giornaleDao.getAllPsp().stream().sorted().collect(Collectors.toList());
  }

  public List<String> getAllTipoEventoPa(){
    return Arrays.stream(Constants.GIORNALE_TIPO_EVENTO_PA.values())
        .map(Constants.GIORNALE_TIPO_EVENTO_PA::toString)
        .sorted()
        .collect(Collectors.toList());
  }

  public List<String> getAllCategoriaEventoPa(){
  ...
  public List<String> getAllEsitoEventoPa(){
