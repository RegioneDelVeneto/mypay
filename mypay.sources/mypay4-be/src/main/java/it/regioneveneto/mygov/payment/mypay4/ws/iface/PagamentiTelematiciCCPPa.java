...
public interface PagamentiTelematiciCCPPa {

  PaaSILVerificaRPRisposta paaSILVerificaRP(PaaSILVerificaRP request, IntestazionePPT header);

  PaaSILAttivaRPRisposta paaSILAttivaRP(PaaSILAttivaRP request, IntestazionePPT header);
}
