...
import it.regioneveneto.mygov.payment.mypay4.extra.AbstractStandaloneApplication;
...
public class BonificaPaSendRtStandaloneApplication extends AbstractStandaloneApplication {
  static final public String NAME = "BonificaPaSendRtStandaloneApplication";
  public static void main(String[] args) {
    //AbstractStandaloneApplication.execute(NAME, args);
