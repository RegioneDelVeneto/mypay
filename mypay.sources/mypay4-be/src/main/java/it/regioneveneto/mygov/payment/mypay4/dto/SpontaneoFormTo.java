...
@NoArgsConstructor
@AllArgsConstructor
public class SpontaneoFormTo extends BaseTo implements Serializable {

  private List<FieldBean> fieldBeans;
  private String importo;
  private String campoTotaleInclusoInXSD;
  private String reCaptchaPublicKey;
  private List<DefinitionDovuto> definitionDovuto;
