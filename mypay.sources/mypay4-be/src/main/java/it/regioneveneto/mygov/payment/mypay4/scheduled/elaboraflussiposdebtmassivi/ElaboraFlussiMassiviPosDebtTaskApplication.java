...
public class ElaboraFlussiMassiviPosDebtTaskApplication extends AbstractTaskApplication{
	static final public String NAME = "ElaboraFlussiMassiviPosDebtTaskApplication";
