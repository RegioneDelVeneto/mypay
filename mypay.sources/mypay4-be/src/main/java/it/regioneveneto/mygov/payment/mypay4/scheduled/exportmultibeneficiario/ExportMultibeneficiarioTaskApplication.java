...
public class ExportMultibeneficiarioTaskApplication extends AbstractTaskApplication{
	static final public String NAME = "ExportMultibeneficiarioTaskApplication";
