...
import it.veneto.regione.pagamenti.pa.PaaSILAttivaEsterna;
import it.veneto.regione.pagamenti.pa.PaaSILAttivaEsternaRisposta;
import it.veneto.regione.pagamenti.pa.PaaSILVerificaEsterna;
import it.veneto.regione.pagamenti.pa.PaaSILVerificaEsternaRisposta;
...
public class PagamentiTelematiciEsterniCCPClient extends BaseClient {
  ...
  public PaaSILVerificaEsternaRisposta paaSILVerificaEsterna(PaaSILVerificaEsterna request, IntestazionePPT header, String wsUrl) {
    ...
    return (PaaSILVerificaEsternaRisposta) getWebServiceTemplate().marshalSendAndReceive(wsUrl, request, getMessageCallback(header));
  }
  ...
  public PaaSILAttivaEsternaRisposta paaSILAttivaEsterna(PaaSILAttivaEsterna request, IntestazionePPT header, String wsUrl) {
    ...
    return (PaaSILAttivaEsternaRisposta) getWebServiceTemplate().marshalSendAndReceive(wsUrl, request, getMessageCallback(header));
  }
}
