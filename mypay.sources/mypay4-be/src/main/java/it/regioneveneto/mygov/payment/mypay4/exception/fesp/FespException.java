 ...
 */
package it.regioneveneto.mygov.payment.mypay4.exception.fesp;
...
public class FespException extends RuntimeException {
  ...
  public FespException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
