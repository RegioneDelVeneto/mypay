...
@Component
@NoArgsConstructor
public class DovutoEntePrimarioToMapper implements RowMapper<DovutoEntePrimarioTo> {

    @Override
    public DovutoEntePrimarioTo map(ResultSet rs, StatementContext ctx) throws SQLException {

        DovutoEntePrimarioTo.DovutoEntePrimarioToBuilder builder = DovutoEntePrimarioTo.builder()
