...
public interface PagamentiTelematiciFlussiSPC {
  ...
  PaaSILChiediFlussoSPCRisposta paaSILChiediFlussoSPC(PaaSILChiediFlussoSPC request);
  PaaSILChiediElencoFlussiSPCRisposta paaSILChiediElencoFlussiSPC(PaaSILChiediElencoFlussiSPC request);
}
