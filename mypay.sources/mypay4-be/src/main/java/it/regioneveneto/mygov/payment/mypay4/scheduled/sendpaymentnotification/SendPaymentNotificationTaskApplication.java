...
public class SendPaymentNotificationTaskApplication extends AbstractTaskApplication{
	static final public String NAME = "SendPaymentNotificationTaskApplication";
