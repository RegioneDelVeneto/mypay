...
public class IuvGenerationException extends MyPayException {
  ...
  public IuvGenerationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
