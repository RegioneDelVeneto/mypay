...
@Schema(description = "i dati del pagamento spontaneo")
public class PagamentoSpontaneoTo extends BaseTo implements Serializable {
  @NotBlank(message = "codeEnte è obbligatorio")
  private String codiceEnte;
  @NotBlank(message = "codeTipoDovuto è obbligatorio")
