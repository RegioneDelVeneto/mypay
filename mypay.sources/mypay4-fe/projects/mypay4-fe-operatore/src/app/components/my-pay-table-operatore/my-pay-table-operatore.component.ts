...
@Component({
selector: 'my-pay-table-operatore',
templateUrl: '../../../../../'+MyPayBaseTableComponent.templateUrl,
styleUrls: ['./my-pay-table-operatore.component.scss'],
animations: MyPayBaseTableComponent.animations
})
export class MyPayTableOperatoreComponent<T> extends MyPayBaseTableComponent<T> implements OnInit, OnChanges
{
